      ...
      >
        <div className="flex items-center justify-between">
          ...
          <motion.a
            ...
            className="text-xl font-bold text-mono-950 dark:text-mono-50 tracking-tight cursor-pointer"
          >
            D.
          </motion.a>
          ...
          <div className="hidden md:flex items-center gap-8">
            {navLinks.map((link, index) => (
              <motion.a
                ...
                className="text-sm text-mono-600 dark:text-mono-400 hover:text-mono-950 dark:hover:text-mono-50 transition-colors cursor-pointer"
              >
                {link.name}
              </motion.a>
            ))}
          ...
          <motion.a
            ...
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.6 }}
            className="flex items-center gap-2 text-sm text-mono-700 dark:text-mono-300 hover:text-mono-950 dark:hover:text-mono-50 transition-colors cursor-pointer"
          >
